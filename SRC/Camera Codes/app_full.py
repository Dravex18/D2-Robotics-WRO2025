"""
=========================================================
 app_full.py – Example Camera Application (Picamera2)
=========================================================

Description
-----------
This script is a full-featured demonstration program from the
official Picamera2 repository. It shows how to build a complete
camera application using the Picamera2 library, including:

- Live preview window.
- Switching between preview, still capture, and video recording.
- Camera controls such as exposure, white balance, and more.
- Saving captured images and video files.

It is intended as a reference example for developers to learn how
to use Picamera2 in real-world applications.

Attribution
-----------
This code was not written by me. It comes directly from the
official Picamera2 project:

    https://github.com/raspberrypi/picamera2

All credit goes to the Picamera2 developers. This copy is included
here for learning and demonstration purposes only.
"""
